            ...
            <div className="max-w-md p-8 m-auto max-h-screen sm:flex sm:space-x-6 dark:bg-gray-100 dark:text-gray-800 mt-8">
                ...
                <div className="flex flex-col space-y-4">
                    <div>
                        ...
                        <span data-aos="fade-left" data-aos-delay="2000" className="text-sm dark:text-gray-600">New Member</span>
                    </div>
                    <div className="space-y-1">
                        <span data-aos="fade-left" data-aos-delay="2200" className="flex items-center space-x-2">
                    ...
                    <div data-aos="zoom-in-down" data-aos-delay="2500">

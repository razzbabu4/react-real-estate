        ...
        <div className="max-w-md p-8 m-auto max-h-screen sm:flex sm:space-x-6 dark:bg-gray-100 dark:text-gray-800">
            ...
            <div className="flex flex-col space-y-4">
                <div>
                    ...
                    <span className="text-sm dark:text-gray-600">New Member</span>
                </div>
                <div className="space-y-1">
                    ...
                    <span className="flex items-center space-x-2">
                        ...
                        <span className="dark:text-gray-600">{user?.phoneNumber || 'Not provided'}</span>
                    </span>
                </div>
                <Link to='/updateProfile' className="btn bg-blue-500 text-lg text-white">Edit Profile</Link>
            </div>
        </div>
    );
};
